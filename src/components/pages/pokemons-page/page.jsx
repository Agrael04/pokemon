...
export default ({ filteredPokemons, collectedPokemons, setFilter, addPokemon }) => (
  <div className={styles.page}>
    <input placeholder='Choose your favourite pokemons!' className={styles.search} onChange={e => setFilter(e.target.value)}/>
